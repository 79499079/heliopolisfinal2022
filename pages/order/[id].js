...
function OrderScreen() {
  ...
  return (
    <Layout title={`Order ${orderId}`}>
      <h2 className="mb-4 text-xl text-center font-bold">Pedido No.</h2>
      <h3 className="mb-4 text-xl text-center font-bold">{`${orderId}`}</h3>
      {loading ? (
        <div>Loading...</div>
      ) : error ? (
        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card  p-5">
              <h2 className="mb-2 text-lg font-bold">Direccion de Envio</h2>
              <div>
              ...
              {isDelivered ? (
                <div className="alert-success">Entregado el {deliveredAt}</div>
              ) : (
            ...
            <div className="card overflow-x-auto p-5">
              <h2 className="mb-2 text-lg font-bold">Productos Solicitados</h2>
